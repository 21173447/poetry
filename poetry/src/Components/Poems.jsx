...
const Poems = () => {
    return (
        <section className='bg-[#251308]  bg-texture lg:h-[90vh] md:h-[90vh] md:pt-10 lg:pt-9'>
            <div className='text-white pt-2 text-3xl text-center'>
                <h1>POEMS</h1>
            ...
            <div className="grid grid-cols-2 place-items-center space-y-4 px-5 sm:py-20 md:grid-cols-4 md:py-1 lg:grid-cols-4 lg:pt-36 lg:px-56">
